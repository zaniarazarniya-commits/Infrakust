...
const projects: Project[] = [
  ...
  {
    id: 2,
    image: '/images/web-thumb-1.jpg',
    name: 'Hedvig',
    description: 'Webbplats i WordPress med modern design och fokus på användarupplevelse.',
    tags: 'WordPress · E-handel',
  },
  {
    id: 3,
    image: '/images/web-thumb-2.jpg',
    name: 'Peder & Co',
    description: 'Logotyper, grafiska profiler och trycksaker med varm, personlig estetik.',
    tags: 'Grafisk design · Profil',
  },
  {
    id: 4,
    image: '/images/web-thumb-3.jpg',
    name: 'Kastell',
    description: 'Land Rover-specialist med komplett webbnärvaro och varumärkesbyggande.',
    tags: 'Fordonsbransch · Webb',
  },
];
